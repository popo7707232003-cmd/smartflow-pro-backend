...
// ?â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â???// SmartFlow Pro ??Market Data API Endpoints
...
export function createMarketRouter(marketData: MarketDataService): Router {
  ...
  // ?â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â???  // GET /api/market/candles/:symbol/:interval
  ...
  // ?â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â???  // GET /api/market/indicators/:symbol
  ...
  // ?â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â???  // GET /api/market/indicators
  ...
  // ?â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â???  // GET /api/market/funding
  ...
  // ?â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â???  // GET /api/market/prices
  ...
  // ?â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â???  // GET /api/market/status
